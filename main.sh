...
while true; do
    ...
    case $choice in
        ...
        2)
            ...
            echo ""
            curl -fsSL "${BASE_URL}/nexus-setup.sh" | bash
            pause
            ;;
        ...
        3)
            ...
            echo ""
            curl -fsSL "${BASE_URL}/panel.sh" | bash
            pause
            ;;
        ...
        4)
            ...
            echo ""
            curl -fsSL "${BASE_URL}/wings.sh" | bash
            pause
            ;;
        ...
        5)
            ...
            echo ""
            curl -fsSL "${BASE_URL}/plugin-client.sh" | bash
            pause
            ;;
        ...
        6)
            ...
            echo ""
            curl -fsSL "${BASE_URL}/restart.sh" | bash
            pause
            ;;
